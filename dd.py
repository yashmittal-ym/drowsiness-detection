        ...
        if ret == True :
            ...
            for (i, rect) in enumerate(rects): 
                ...
                if EAR < EAR_THRESHOLD: 
                    ...
                    FRAME_COUNT = 0
                cv2.putText(frame, "EAR: {:.2f}".format(EAR), (100, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                ...
                cv2.putText(frame, "MAR: {:.2f}".format(MAR), (100, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
